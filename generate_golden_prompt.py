...
def add_block(lines, filename, code_lines):
...
final_content = restart_header.copy()

# Добавляем исходники
add_block(final_content, "main.py", code_main)
add_block(final_content, "src/db_connector.py", code_db) # (Defined in previous prompt scripts, assuming user has it)
add_block(final_content, "src/parser.py", code_parser) # (Defined in previous prompt)
add_block(final_content, "src/processing.py", code_processing)
add_block(final_content, "src/fifo.py", code_fifo)
add_block(final_content, "src/data_collector.py", code_collector)
add_block(final_content, "src/excel_exporter.py", code_excel)
add_block(final_content, "src/report_pdf.py", code_report_pdf)
add_block(final_content, "src/utils.py", code_utils)
add_block(final_content, "src/nbp.py", code_nbp)

# Добавляем тесты
add_block(final_content, "tests/test_fifo.py", code_test_fifo)
add_block(final_content, "tests/test_processing.py", code_test_processing)
add_block(final_content, "tests/test_utils.py", code_test_utils)
add_block(final_content, "tests/test_db_connector.py", code_test_db)

final_content.append("**INSTRUCTION:** Restore these files and run `pytest`.")

if __name__ == "__main__":
    print("🚀 Generating Golden Restart Prompt...")
    write_lines("RESTART_PROMPT.md", final_content)
    print("🎉 Done! Use this file for future chats.")
