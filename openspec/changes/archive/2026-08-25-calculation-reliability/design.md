...
2. Add a calculation diagnostics model containing missing-rate events, unmatched sell quantities, unsupported corporate actions, and report-export errors. Thread it through processing and CLI output.
...
4. Ensure PDF and Excel exporters receive the same validated result and cannot be reported as successful when an exporter fails.
5. Add focused tests for NBP outage, unmatched sells, same-day ordering, and exporter failure. Add fixtures that verify a valid calculation remains unchanged.
