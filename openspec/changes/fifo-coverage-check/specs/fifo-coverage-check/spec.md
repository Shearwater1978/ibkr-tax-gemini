...
Provide a non-destructive preflight check that confirms whether imported broker history contains enough asset quantity and FIFO lot evidence to support one or more planned sales before the user relies on the result for a tax return.
