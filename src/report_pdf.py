...
def generate_pdf(json_data, filename="report.pdf"):
    ...
    elements.append(Paragraph("Detailed breakdown of all fees paid to the broker for trade execution.", normal_style))
    elements.append(Spacer(1, 10))
    ...
    if comm_rows:
        t_comm = Table(comm_header + comm_rows, colWidths=[25, 80, 70, 80, 80, 60], repeatRows=1)
